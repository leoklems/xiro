    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='media/lib_slider.jpg', null=True, upload_to='slides/')),
            ],
            options={
                'ordering': ('index',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_id', models.SlugField(blank=True, max_length=20, null=True)),
                ('image', models.ImageField(blank=True, default='media/blog.jpeg', null=True, upload_to='post/')),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('views', models.IntegerField(blank=True, default=0, null=True)),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='post_author', to='contents.author')),
            ],
        ),
        migrations.CreateModel(
            name='Activity',
            fields=[
                ...
                ('actor', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='actor', to='contents.author')),
            ],
        ),
    ]
